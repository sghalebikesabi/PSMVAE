...
df = df.loc[df['Tags'].isin(['run_ratio'])]
...
ax = plt.subplot(111)
i = 0
averaged_df = averaged_df[(averaged_df['model_class'].isin(['PSMVAE_a', 'PSMVAE_b'])) & (averaged_df['Missingness'].isin(['MCAR', 'MNAR1var'])) & (averaged_df['miss ratio']=='80')]
