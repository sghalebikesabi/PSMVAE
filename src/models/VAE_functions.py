...
import models.loglik_models_missing_normalize as loglik_models_missing_normalize
import numpy as np

def place_holder_types(data, batch_size):
    ...
    types_list = [{'dim': 1, 'nclass': '', 'type': 'real'}] * data.shape[1]
