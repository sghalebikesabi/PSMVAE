...
def getArgs(argv=None):
    ...
    parser.add_argument('--model_name', type=str, default='model_HIVAE_inputDropout', help='File of the training model')
    parser.add_argument('--save_file', type=str, default='new_mnist_zdim5_ydim10_4images_', help='Save file name')
    parser.add_argument('--data_file', type=str, default='Breast/data.csv', help='File with the data')
    parser.add_argument('--types_file', type=str, default='Breast/data_types_real.csv', help='File with the types of the data')
    parser.add_argument('--miss_file', type=str, default='Breast/Missing10_1.csv', help='File with the missing indexes mask')
    parser.add_argument('--true_miss_file', type=str, default='Breast/Missing10_1.csv', help='File with the missing indexes when there are NaN in the data')
