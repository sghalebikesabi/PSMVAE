...
def read_data(data, M_sim_miss):
    ...
    types_dict = [{'dim': 1, 'nclass': '', 'type': 'real'}] * data.shape[1]
    ...
    true_miss_mask = 1 - (np.isnan(data)*1 - M_sim_miss*1) 
    ...
    return data, types_dict, 1-M_sim_miss, true_miss_mask, n_samples
