...
for seed in ((seed=0; seed<=4; seed++))
do
    for input in letter wine letter adult credit spam 
    do
        ...
        do
            ...
            do
                ...
                do
                    ...
                    miss_file="data/${input}/miss_data/${miss_type}_notuniform_frac_${miss_ratio}_seed_${seed}"
                    wandb_run_name="${model_class}_${input}_${miss_type}_notuniform_frac_${miss_ratio}_seed_${seed}"
